...
while True:
    ...
    if menu == "3":
        ...
        if os.path.exists("hwvenderlist"):
            ...
            venderfile = input("Please enter the name of the file with hardware venders, or leave this blank.\n")
        if venderfile != "":
    ...
    if menu == "4":
        ...
        savedfile = input("If you would like to save the matches to a file enter a file name.\n")
        f1 = open(file1,"r")
        f2 = open(file2,"r")
    ...
    if menu == "5":
        ...
        if interface == "":
            ...
            interface = input("Please enter your wireless interface: (ex. wlan0mon)\n")
        clients = {}
        hwaddressfile = input("Please enter the filename that contains the addresses you would like to scan for\n")
        file_name = input("Enter the name of the file to output successful scan info.  (date/time GPS)\n")
        if file_name == "":
            file_name = "wt-option5-default-output-" + str(datetime.datetime.now())
        systemcommand = input("Enter a shell command to run on a successful scan. (ex. vlc ring.wav)\n")
    ...
    if menu == "6":
        ...
        clientmac = input("Please enter the mac address of the client.\n")
